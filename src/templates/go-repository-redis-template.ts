...
export function getRepositoryRedisTemplate(
  name: string
) {
...
func NewRedisRepository(redisURL string) (${paramCaseName}.${pascalCaseName}Repository, error) {
...
func (r *redisRepository) Find(code string) (*${paramCaseName}.${pascalCaseName}, error) {
